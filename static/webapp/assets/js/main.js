...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (tempoverlaymenu) {
    tempoverlaymenu.addEventListener("click", function () {
      ...
      if (
        ...
        document
          .querySelector(".app-menu-overlay")
    ...
    verticalnavtoggle.addEventListener("click", function () {
      if (document.body.classList.contains("minimenu")) {
        ...
        var elem = document.querySelectorAll(
          ".app-navbar li:not(.nav-provoke) .nav-submenu"
        );
        ...
        var tc = document.querySelectorAll(".app-navbar li .nav-submenu");
  ...
  if (mobilecollapsever) {
    mobilecollapsever.addEventListener("click", function () {
      ...
      var tempsdbr = document.querySelector(".app-sidebar");
      if (tempsdbr) {
        if (
          document
            .querySelector(".app-sidebar")
  ...
  var topbarlinklist = document.querySelector(
    ".dash-horizontal .topbar .app-navbar>li>a"
  );
  if (topbarlinklist) {
  ...
  if (document.querySelector(".ntf-dropdown .notification-body")) {
    var px = new SimpleBar(document.querySelector(".ntf-dropdown .notification-body"), {
      autoHide: true
    });
  }
...
function horizontalmobilemenuclick() {
  ...
  for (var i = 0; i < pclinkclick.length; i++) {
    pclinkclick[i].addEventListener("click", function (event) {
      ...
      if (targetElement.parentNode.classList.contains("nav-provoke")) {
        targetElement.parentNode.classList.remove("nav-provoke");
      } else {
        var tc = document.querySelectorAll("li.nav-provoke");
        for (var t = 0; t < tc.length; t++) {
          var c = tc[t];
          c.classList.remove("nav-provoke");
        }
        targetElement.parentNode.classList.add("nav-provoke");
      }
    });
  }
  var pcsublinkclick = document.querySelectorAll(
    ".app-navbar > li:not(.nav-caption) > .nav-submenu > li"
  );
  for (var n = 0; n < pcsublinkclick.length; n++) {
    pcsublinkclick[n].addEventListener("click", function (event) {
      ...
      if (targetElement.parentNode.classList.contains("nav-provoke")) {
        ...
        var tc = document.querySelectorAll(".nav-submenu li.nav-provoke");
        for (var t = 0; t < tc.length; t++) {
          var c = tc[t];
          c.classList.remove("nav-provoke");
        }
  ...
  var pcsubchildlinkclick = document.querySelectorAll(
    ".app-navbar > li:not(.nav-caption) > .nav-submenu >  li > .nav-submenu >  li"
  );
    ...
    pcsubchildlinkclick[n].addEventListener("click", function (event) {
      ...
      if (targetElement.parentNode.classList.contains("nav-provoke")) {
        ...
        var tc = document.querySelectorAll(
          ".nav-submenu .nav-submenu li.nav-provoke"
        );
        for (var t = 0; t < tc.length; t++) {
          var c = tc[t];
          c.classList.remove("nav-provoke");
...
function menuclick() {
  var vw = window.innerWidth;
  var elem = document.querySelectorAll(".app-navbar li");
  for (var j = 0; j < elem.length; j++) {
  ...
  if (!document.querySelector("body").classList.contains("minimenu")) {
    ...
    var pcsublinkclick = document.querySelectorAll(
      ".app-navbar > li:not(.nav-caption) li"
    );
      ...
      pcsublinkclick[i].addEventListener("click", function (event) {
        ...
        if (targetElement.parentNode.classList.contains("nav-provoke")) {
          ...
          for (var t = 0; t < tc.length; t++) {
            ...
            if (c.parentNode.classList.contains("nav-hasmenu")) {
...
function rmdrp() {
  document
    .querySelector(".site-header:not(.dash-mob-header) .dash-mob-drp")
    .classList.remove("mob-drp-active");
  document
    .querySelector(".site-header:not(.dash-mob-header) .dash-md-overlay")
    .remove();
}

function rmthead() {
  document
    .querySelector(".site-header:not(.dash-mob-header)")
...
function rmmenu() {
  var tempov = document.querySelector(".app-sidebar");
  if (tempov) {
    document
      .querySelector(".app-sidebar")
  ...
  document.querySelector(".app-sidebar .app-menu-overlay").remove();
}
...
function rmactive() {
  document
    .querySelector(".app-sidebar .app-navbar li")
    .classList.remove("active");
  document
    .querySelector(".app-sidebar .app-navbar li")
    .classList.remove("nav-provoke");
  ...
  document.querySelector(".app-sidebar .app-menu-overlay").remove();
  document.querySelector(".topbar .app-menu-overlay").remove();
}
...
var elem = document.querySelectorAll(".app-sidebar .app-navbar a");
for (var l = 0; l < elem.length; l++) {
  ...
  if (elem[l].href == pageUrl && elem[l].getAttribute("href") != "") {
    ...
    elem[l].parentNode.parentNode.parentNode.classList.add("nav-provoke");
...
if (document.querySelector("body").classList.contains("layout-topbar")) {
  var tplink = document.querySelectorAll(
    ".site-header .list-unstyled > .dropdown"
  );
...
if (document.querySelector("body").classList.contains("dash-horizontal")) {
  ...
  if (docW > 1024) {
    var topbarhasmenu = document.querySelector(
      ".dash-horizontal .topbar .nav-submenu .nav-hasmenu"
    );
    if (topbarhasmenu) {
...
function collapseedge() {
  ...
  if (docW > 1024) {
    var minimenuhasmenu = document.querySelector(
      ".minimenu .app-sidebar .nav-submenu .nav-hasmenu"
    );
    if (minimenuhasmenu) {
